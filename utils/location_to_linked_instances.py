#imported from region project needs adaptation to work in heritage
#shows entries linked to a location
#makes a save of all instances linked to a specific country or region
#if a country or region contains many (ie > 50) locations because this would
#take a long time to compute (create for region timeline view)
