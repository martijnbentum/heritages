...
urlpatterns = [
	...
	path('add_location/<str:view>', views.edit_location, 
		name='add_location'),
	path('edit_location/<int:pk>', views.edit_location, 
		name='edit_location'),
	path('edit_location/<str:focus>/<str:view>/<int:pk>', views.edit_location, 
		name='edit_location'),
	path('edit_location/<str:focus>/<int:pk>', views.edit_location, 
		name='edit_location'),
